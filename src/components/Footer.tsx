        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3">
              <div className="bg-brand-600 p-3 rounded-2xl shadow-xl shadow-brand-600/20 border border-brand-500">
                <Phone className="w-6 h-6 text-white" />
              </div>
              <div>
                <h1 className="text-2xl font-black leading-none text-white tracking-tight">Royal Plumbing Services</h1>
                <span className="text-[10px] uppercase tracking-[0.3em] font-black text-gold-500">Faridabad's Choice</span>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              {[Facebook, Instagram, Twitter].map((Icon, i) => (
                <a key={i} href="#" className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white hover:bg-gold-500 hover:text-white hover:scale-110 transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-gold-600/10 flex items-center justify-center shrink-0">
                  <div className="w-2 h-2 rounded-full bg-gold-500 animate-pulse" />
                </div>
                <div>
                  <p className="text-white font-black">Emergency</p>
                  <p className="text-gold-500 font-black text-sm">Available 24/7</p>
                </div>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              {['Emergency Repairs', 'Service Area', 'Bathroom Fitting', 'Drain Cleaning', 'Water Heater', 'Pipe Installation'].map((link, i) => (
                <li key={i}>
                  ...
                  >
                    <ArrowRight className="w-4 h-4 text-gold-500 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all" />
                    {link}
                  </a>
                </li>
              ))}
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <a href="tel:+918287023020" className="text-white font-black hover:text-gold-500 transition-colors text-lg">+91 82870 23020</a>
                </div>
              </li>
